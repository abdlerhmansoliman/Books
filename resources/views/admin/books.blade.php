                    ...
                    <div class="relative inline-block text-left" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                            ...
                            <div class="py-1" role="none">
                                <a href="{{route('dashboard.edit',['type' => 'book', 'id' => $book->id] )}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1">Edit</a>
                                <form method="POST" action="{{route('dashboard.delete', ['type' => 'book', 'id' => $book->id]) }} "onsubmit="return confirm('هل أنت متأكد من حذف هذا المستخدم؟');>
                                    @csrf
                                    @method('DELETE')
